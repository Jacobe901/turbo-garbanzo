...
console.log("\x1b[93mLoading Overflow Bot...\x1b[0m");const config = require('./config.json');
...
bot.on('ready', () => {
	...
	console.log(`\x1b[36m ${String.raw` /$$__  $$                               /$$__  $$| $$                              | $$__  $$            | $$    `} \x1b[0m`);
	console.log(`\x1b[36m ${String.raw`| $$  \ $$ /$$    /$$ /$$$$$$   /$$$$$$ | $$  \__/| $$  /$$$$$$  /$$  /$$  /$$      | $$  \ $$  /$$$$$$  /$$$$$$  `} \x1b[0m`);
	console.log(`\x1b[36m ${String.raw`| $$  | $$|  $$  /$$//$$__  $$ /$$__  $$| $$$$    | $$ /$$__  $$| $$ | $$ | $$      | $$$$$$$  /$$__  $$|_  $$_/  `} \x1b[0m`);
	console.log(`\x1b[36m ${String.raw`| $$  | $$ \  $$/$$/| $$$$$$$$| $$  \__/| $$_/    | $$| $$  \ $$| $$ | $$ | $$      | $$__  $$| $$  \ $$  | $$    `} \x1b[0m`);
	console.log(`\x1b[36m ${String.raw`| $$  | $$  \  $$$/ | $$_____/| $$      | $$      | $$| $$  | $$| $$ | $$ | $$      | $$  \ $$| $$  | $$  | $$ /$$`} \x1b[0m`);
	console.log(`\x1b[36m ${String.raw`|  $$$$$$/   \  $/  |  $$$$$$$| $$      | $$      | $$|  $$$$$$/|  $$$$$/$$$$/      | $$$$$$$/|  $$$$$$/  |  $$$$/`} \x1b[0m`);
	console.log(`\x1b[36m ${String.raw` \______/     \_/    \_______/|__/      |__/      |__/ \______/  \_____/\___/       |_______/  \______/    \___/  `} \x1b[0m`);
	console.log(`Created by \x1b[36m FAXES - www.faxes.zone \x1b[0m`)
	console.log(`\x1b[32mOverflow Bot has loaded & Online. If you experience errors try turn debug mode on. \x1b[0m`);
